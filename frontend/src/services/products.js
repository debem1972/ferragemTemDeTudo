const mockProducts = [
  ...
  {
    id: 10,
    nome: 'Microinversor Solar 1000W',
    categoria: 'energia-solar',
    categoriaLabel: 'Energia solar',
    descricao: 'Microinversor monofasico com monitoramento para sistemas fotovoltaicos de alta eficiencia.',
    preco: 899.9,
    badge: 'Microinversor',
    ...
    curatedHighlights: [
      ...
      { icon: 'bi-shield-check', label: 'Protecao IP67 externa' },
    ],
  },
  {
    id: 11,
